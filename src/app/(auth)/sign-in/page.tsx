      ...
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        <div className="w-full max-w-md p-8 space-y-8 bg-white rounded-lg shadow-md items-center flex flex-col">
          <h4 className="text-2xl font-extrabold tracking-tight lg:text-4xl mb-6 text-center">Dive into the world of Mystery Message</h4>
              <input type="text" placeholder='username' name='username' onChange={(e)=>setUsername(e.target.value)} className="border-black border-b-2 h-9 w-[260px] p-1 mb-4 focus:outline-none focus:border-b-blue-300 rounded-sm"/>
              <input type="password" placeholder='password' name='password' onChange={(e)=>setPassword(e.target.value)} className="border-black border-b-2 h-9 w-[260px] p-1 mb-4 rounded-sm focus:outline-none focus:border-b-blue-300"/>
